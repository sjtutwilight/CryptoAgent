-- ============================================================================
-- Token Holders 分析 SQL
-- 用于 StarRocks 通过 Paimon Catalog 查询和分析 Token 持有者数据
-- ============================================================================

-- 前置条件：确保 StarRocks 已配置 Paimon Catalog
...
-- ============================================================================
-- 5. 综合指标汇总表 (用于创建 StarRocks 物化视图或定期更新)
-- ============================================================================

CREATE TABLE IF NOT EXISTS analytics.token_holder_metrics (
...
-- 插入汇总数据的示例 SQL
-- INSERT INTO analytics.token_holder_metrics
-- SELECT ... FROM paimon_catalog.crypto_analytics.token_holders_snapshot
-- (结合上面的分析SQL生成汇总数据)
