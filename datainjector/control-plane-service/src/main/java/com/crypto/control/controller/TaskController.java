...
public class TaskController {
    ...
    public ResponseEntity<ApiResponse<TaskResponse>> createTask(
        ...
        try {
            log.info("接收到任务创建请求: dataSource={}, taskType={}, payloadKeys={}", 
                    request.getDataSourceId(), request.getTaskType(), 
                    request.getPayload() != null ? request.getPayload().keySet() : java.util.Collections.emptySet());
