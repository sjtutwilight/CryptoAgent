...
type WebSocketFaultConfig struct {
	...
	DisconnectionEveryN         int     `mapstructure:"disconnection_every_n"`
	DataLossEveryN              int     `mapstructure:"data_loss_every_n"`
}
...
func setDefaults() {
	...
	viper.SetDefault("fault.websocket.disconnection_every_n", 0)
	viper.SetDefault("fault.websocket.data_loss_every_n", 0)
