...
usage() {
  cat <<USAGE
Usage: ./automation/data/query/starrocks_paimon_query.sh [options]
...
Examples:
  ./automation/data/query/starrocks_paimon_query.sh --mode count
  ./automation/data/query/starrocks_paimon_query.sh --mode sample --limit 10 --chain-id 1
USAGE
}
